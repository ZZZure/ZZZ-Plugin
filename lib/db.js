import { getDB, setDB, removeDB, getAllDB, removeAllDB } from './db/core.js';
 ...
 */
export function getAllAbyssData() {
  return getAllDB('abyss');
}
 ...
 * @returns {object}
 */
export function getAllDeadlyData() {
  return getAllDB('deadly');
}
