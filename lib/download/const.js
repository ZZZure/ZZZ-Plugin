...
export const HAKUSH_CHARACTER_DATA_PATH = path.join(
  ...
  HAKUSH_IMAGE_PATH = path.join(imageResourcesPath, 'hakush'),
  HAKUSH_UI_PATH = path.join(HAKUSH_IMAGE_PATH, 'ui'),
  HAKUSH_ZZZ_ROLE_PATH = path.join(HAKUSH_IMAGE_PATH, 'role'),
  HAKUSH_ZZZ_ROLE_CIRCLE_PATH = path.join(HAKUSH_IMAGE_PATH, 'role_circle'),
  HAKUSH_ZZZ_SMALL_SQUARE_AVATAR_PATH = path.join(HAKUSH_IMAGE_PATH, 'role_general'),
  HAKUSH_ZZZ_SQUARE_AVATAR_PATH = path.join(HAKUSH_IMAGE_PATH, 'square_avatar'),
