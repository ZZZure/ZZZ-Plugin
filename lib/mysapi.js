...
export default class MysZZZApi extends MysApi {
  ...
  getUrl(type, data = {}) {
    ...
    if (data?.deviceInfo && data?.modelName && data?.osVersion) {
      ...
      try {
        ...
        headers[
          'User-Agent'
        ] = `Mozilla/5.0 (Linux; Android ${osVersion}; ${modelName} Build/${deviceDisplay}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.88 Mobile Safari/537.36 miHoYoBBS/2.73.1`;
      } catch (error) {
  ...
  getHeaders(query = '', body = '') {
    ...
    const cn = {
      app_version: '2.73.1',
      User_Agent: `Mozilla/5.0 (Linux; Android ${osVersion}; ${modelName} Build/${deviceDisplay}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.88 Mobile Safari/537.36 miHoYoBBS/2.73.1`,
      client_type: '5',
    ...
    const os = {
      app_version: '2.57.1',
      User_Agent: `Mozilla/5.0 (Linux; Android ${osVersion}; ${modelName} Build/${deviceDisplay}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.88 Mobile Safari/537.36 miHoYoBBSOversea/2.57.1`,
      client_type: '2',
