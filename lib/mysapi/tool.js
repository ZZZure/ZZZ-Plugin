...
export default class ZZZApiTool {
  ...
  getUrlMap = (data = {}) => {
    ...
    const {
      productName = _.get(deviceCfg, defDeviceCfg, 'productName'),
      deviceType = _.get(deviceCfg, defDeviceCfg, 'productType'),
      modelName = _.get(deviceCfg, defDeviceCfg, 'modelName'),
      oaid = _.get(deviceCfg, defDeviceCfg, 'oaid'),
      deviceInfo = _.get(deviceCfg, defDeviceCfg, 'deviceInfo'),
      board = _.get(deviceCfg, defDeviceCfg, 'board'),
    } = data;
