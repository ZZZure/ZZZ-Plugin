...
export default class ZZZApiTool {
  ...
  getUrlMap = (data = {}) => {
    const {
      productName = settings.getConfig('device')?.productName,
      deviceType = settings.getConfig('device')?.productType,
      modelName = settings.getConfig('device')?.modelName,
      oaid = settings.getConfig('device')?.oaid,
      deviceInfo = settings.getConfig('device')?.deviceInfo,
      board = settings.getConfig('device')?.board,
    } = data;
