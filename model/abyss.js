...
export class FloorDetail {
  ...
  constructor(data) {
    ...
    /** @type {number} */
    this.total_battle_time = this.node_1.battle_time + this.node_2.battle_time
  }

  get formattedTotalBattleTime() {
    const seconds = this.total_battle_time % 60;
    const minutes = Math.floor(this.total_battle_time / 60);
    return `${minutes ? minutes + '分' : ''}${seconds + '秒'}`;
  }
