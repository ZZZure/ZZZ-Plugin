...
- buff注册方法：武器、套装、角色每部分buff的注册，都存在两种方式：
  ...
  - 一：[直接导出](./character/模板/calc.js#L67)：在计算文件中导出buffs数组，数组中保存各buff即可
  - 二：[函数导出](./character/模板/calc.js#L1)：调用[BuffManager](./BuffManager.ts#L153)实例**buffM**的**new**方法，传入你需要注册的buff即可
