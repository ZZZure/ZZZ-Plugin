...
export class Manage extends ZZZPlugin {
  downloadAll: typeof manage.assets.downloadAll
  deleteAll: typeof manage.assets.deleteAll
  ...
  getChangeLog: typeof manage.version.getChangeLog
  getCommitLog: typeof manage.version.getCommitLog
  hasUpdate: typeof manage.version.hasUpdate
  enableAutoUpdatePush: typeof manage.version.enableAutoUpdatePush
  setCheckUpdateCron: typeof manage.version.setCheckUpdateCron
  setDefaultDevice: typeof manage.device.setDefaultDevice
  toSetDefaultDevice: typeof manage.device.toSetDefaultDevice
  switchGroupRank: typeof manage.rank.switchGroupRank
  resetGroupRank: typeof manage.rank.resetGroupRank
  ...
  constructor() {
    super({
      ...
      rule: [
        ...
        {
          reg: `${rulePrefix}(开启|打开|on|启用|启动|关闭|关掉|off|禁用|停止)群(内)?(式舆防卫战|式舆|深渊|防卫战|防卫|危局强袭战|危局|强袭|强袭战|临界推演|临界|推演)排名$`,
          fnc: 'switchGroupRank'
        },
        {
