 ...
 * 邦布ID转数据
 */
export const bangbooIdToData = (bangboo_id: string | number) => {
 ...
 * 邦布ID转中文名
 */
export const bangbooIdToName = (bangboo_id: string | number) => {
 ...
 * 邦布ID转图片名
 */
export const bangbooIdToSprite = (bangboo_id: string | number) => {
