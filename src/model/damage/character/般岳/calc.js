...
export default {
  ...
  buffs: [
    ...
    },
    {
      ...
      type: "增伤",
      value: 0.3,
      include: ["EEAEAAE", "EAEAEEA", "AQS", "ACY"],
    },
    {
      name: "6影",
      type: "增伤",
  ...
  skills: [
    ...
    { name: "强化特殊技：地动", type: "EAEA" },
    { name: "强化特殊技：山摇", type: "EEEA" },
    { name: "强化特殊技：论道", type: "EEAE" },
    { name: "强化特殊技：狮子吼", type: "EAAE" },
    { name: "强化特殊技：山摇·怒", type: "EAEAEEA" },
    { name: "强化特殊技：狮子吼·怒", type: "EEAEAAE" },
    { name: "连携技：怒焰", type: "RL" },
