...
2. 权重：不同词条对角色的重要性数值，决定该词条在评分中的占比，有效值0~1，一般为0.1或0.25的整数倍
...
| 锋御·双爆 | 通用 | 防御力%=1<br>暴击率=1<br>暴击伤害=0.75<br>穿透率=1 |
...
| 冲击·双爆 | 双爆总和≥1.5<br>异常属性较低 | 冲击力=1<br>暴击率=1<br>暴击伤害=1<br>攻击力%=0.75 |
| 冲击·攻击 | 攻击力>2000<br>双爆总和≥1<br>异常属性较低 | 冲击力=1<br>攻击力%=1<br>暴击率=1<br>暴击伤害=0.75 |
| 冲击·异常 | 双爆总和<2<br>异常属性较高 | 异常精通=1<br>异常掌控=1<br>冲击力=1<br>攻击力%=0.75 |

所有规则中，穿透率权重均为1（命破除外），穿透值权重均为0.25（命破除外），属性伤害加成权重均为1

完整权重详见[此文件](./Score.ts#L218)
